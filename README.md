...
Este repositorio recibe errores, propuestas y reportes comunitarios.

El código fuente de producción no se distribuye aquí.
...
Consultá [CONTRIBUTING.md](CONTRIBUTING.md) antes de participar.
...
Algunos datos son predicciones. Otros son horarios programados.

La aplicación identifica cada caso cuando la fuente lo permite.
